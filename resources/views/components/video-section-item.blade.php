<div class="w-full md:w-1/2 xl:w-1/3 px-4">
    <div class="bg-white rounded-lg mb-10">
        ...
        <section
                ...
                <div class="w-full aspect-video relative z-20">
                    ...
                    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-primary bg-opacity-0 z-10">
                        ...
                        class="flex items-center justify-center w-20 md:w-[70px] h-20 md:h-[70px] rounded-full bg-white text-primary absolute z-20">
                            <span class="absolute w-full h-full rounded-full top-0 right-0 bg-white bg-opacity-20 z-[-1] animate-ping delay-300 duration-1000">
                            </span>
                            <svg
                                class="ml-2"
                                width="23"
            ...
            <!-- Video -->
            <div x-show="videoOpen" x-transition class="fixed top-0 left-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70">
                <div @click.outside=""
                    class="md:w-10/12 w-11/12 xl:w-8/12 mx-auto bg-white">
                    <iframe x-bind:src="url" frameborder="0" class="w-full aspect-video">
        ...
        <div class="p-6 xl:p-7 2xl:p-9 h-[320px] overflow-hidden text-center">
            <h3>
                <a href="https://youtu.be/{{$videoId}}" target="_blank"
                   class="text-dark font-bold text-lg mb-4 block hover:text-primary">
                    {{$title}}
                </a>
            </h3>
