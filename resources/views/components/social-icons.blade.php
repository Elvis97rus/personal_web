<div {{$attributes->class(['flex items-center'])}}>
    <a
        ...
        target="_blank"
        class="text-dark dark:text-white hover:bg-primary hover:border-primary hover:dark:border-primary mr-3 flex h-10 w-10 items-center
